...
<body>
  ...
  <h2 style="font-size: 20px;">รายชื่อพนักงานทั้งหมด</h2>
            ...
            <table class="table datatable" id="employeesTable" style="width: 100%; border-collapse: collapse; border: 1px solid #ddd;">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center; border: 1px solid #ddd;">ฝ่าย</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if ($userroleResult && $userroleResult->num_rows > 0): ?>
                        ...
                        <?php while ($row = $userroleResult->fetch_assoc()): ?>
                            <tr>
                                <td style="text-align: right; border: 1px solid #ddd;"><?php echo $index++; ?></td> <!-- แสดงลำดับ -->
                                <td style="border: 1px solid #ddd; text-align: center;">
    <a href="employee_tasks2.php?username=<?php echo urlencode($row['Username']); ?>">
        <?php echo htmlspecialchars($row['Username']); ?>
    </a>
</td>

                                <td style="border: 1px solid #ddd;"><?php echo htmlspecialchars($row['FirstName'] . ' ' . $row['LastName']); ?></td>
                                <td style="border: 1px solid #ddd;"><?php echo htmlspecialchars($row['Position']); ?></td>
                                <td style="border: 1px solid #ddd;"><?php echo htmlspecialchars($row['Department']); ?></td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="5" class="text-center" style="border: 1px solid #ddd;">ไม่พบพนักงานในฐานข้อมูล</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
